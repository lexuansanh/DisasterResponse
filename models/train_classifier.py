...
def tokenize(text):
    ...
    OUTPUT - lemmed_text - List - List of tokenizes of text
    '''
    # Normalize
    ...
    # Lemmatization
    lemmed_text = [WordNetLemmatizer().lemmatize(w, pos='v') for w in stemmed_text]
...
def evaluate_model(model, X_test, Y_test, category_names):
    ...
    for col_id in range(len(category_names)):
        print(classification_report(Y_pred[:,col_id],Y_test[category_names[col_id]])) 
